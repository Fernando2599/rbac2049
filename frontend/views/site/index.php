                ...
                <div class="row align-items-center justify-content-lg-between justify-content-center gy-4">
                    ...
                    <div class="col-lg-6">
                        <div class="text-muted">
                            <h1 class="mb-3 lh-base">¿Que es el modelo de <span class="text-primary">Educación Dual</span>?</h1>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 fw-semibold lh-base">¿Como funciona el<span class="text-primary"> Modelo dual</span>?</h1>
