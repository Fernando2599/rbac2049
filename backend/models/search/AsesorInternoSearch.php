...
/**
 * AsesorInternoSearch represents the model behind the search form of `common\models\AsesorInterno`.
 */
class AsesorInternoSearch extends AsesorInterno
{
