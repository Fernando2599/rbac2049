...
$this->registerJsFile(
    '@web/theme/functionAjax/EmpresaAjax.js',
...
<div class="empresa-index">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <?=
            Html::a(Yii::t('app', 'Crear Empresa'), ['create'], ['class' => 'btn btn-outline-secondary btn-border'])
            ?>
        </div>
                        ...
                        [
                            ...
                            'buttons' => [
                                'delete' => function ($url, $model, $key) {
                                    return '<a href="#" class="delete-empresa-button" data-bs-toggle="modal" data-bs-target="#removeEmpresaModal" data-empresa-id="' . $model->id . '"><i class="ri-delete-bin-fill align-bottom"></i></a>';
                                },
                            ],
    ...
    <!-- removeProjectModal -->
    <div id="removeEmpresaModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
