...
<div class="especialidad-index">
    ...
    <div class="card">
                        ...
                        [
                            ...
                            'buttons' => [
                                'delete' => function ($url, $model, $key) {
                                    return '<a href="#" class="delete-especialidad-button" data-bs-toggle="modal" data-bs-target="#removeEspecialidadModal" data-especialidad-id="' . $model->id . '"><i class="ri-delete-bin-fill align-bottom"></i></a>';
                                },
                            ],
        ...
        <!-- removeProjectModal -->
        <div id="removeEspecialidadModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
