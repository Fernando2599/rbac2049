...
<div class="asesor-interno-index">
    ...
    <?php $this->title = 'Asesores Internos';
    ...
    <div class="card">
        ...
        <div class="card-header">
            <?=
            Html::a(Yii::t('app', 'Crear Asesor'), ['create'], ['class' => 'btn btn-outline-secondary btn-border'])
            ?>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <?= GridView::widget([
                    ...
                    /*'summary' => 'Mostrando del {begin}-{end} de {totalCount} asesores internos.',
